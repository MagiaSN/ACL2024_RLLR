...
from llmtuner.extras.save_and_load import load_valuehead_params,load_valuehead_params_rationale
    ...
    if stage == "rm" or stage == "ppo":
        ...
        if stage == "ppo": # load reward model
            ...
            if getattr(model, "is_peft_model", False):
                ...
                if model_args.reward_model_rationale is not None:
                    model.pretrained_model.load_adapter(model_args.reward_model_rationale, "reward_rationale")
                    assert load_valuehead_params_rationale(model, model_args.reward_model_rationale), "Reward-rationale model is not correctly loaded."
