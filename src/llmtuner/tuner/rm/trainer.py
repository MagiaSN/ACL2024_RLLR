...
class PairwiseTrainer(Trainer):
    ...
    def __init__(self, bpr_temperature=1.0, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.can_return_loss = True # override property to return eval_loss
        self.bpr_temperature = bpr_temperature
    ...
    def compute_loss(
        ...
        for i in range(batch_size):
            ...
            loss += -torch.nn.functional.logsigmoid((chosen_trunc_rewards - rejected_trunc_rewards) / self.bpr_temperature).mean()
