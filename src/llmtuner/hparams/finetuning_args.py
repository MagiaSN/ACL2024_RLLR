...
class FinetuningArguments:
    ...
    ppo_mini_batch_size: Optional[int] = field(
        default=None,
        metadata={"help": "Number of samples optimized in each mini batch."}
    )
    ...
    bpr_temperature: Optional[float] = field(
        default=1.0,
        metadata={"help": "The temperature parameter for the BPR loss in reward modeling."}
    )
