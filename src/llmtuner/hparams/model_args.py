...
class ModelArguments:
    ...
    reward_model_rationale: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the directory containing the checkpoints of the reward model for rationale selection."}
    )
    ...
    label_reward_threshold: Optional[float] = field(
        default=1.0,
        metadata={"help": "The threshold for the label reward in reward modeling."}
    )
